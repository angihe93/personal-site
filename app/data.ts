...
export const PROJECTS: Project[] = [
  // todo: kalshi hourly crypto
  // write about projects if hard to show
  {
    name: 'Kalshi Hourly Crypto Stats',
    description:
      "One of the tools I've built for trading crypto markets on Kalshi. It calculates empirical probabilities for future prices based on real time BTC & ETH prices.",
    link: 'https://kalshi-hourly-crypto-client.vercel.app',
    image: '/projects/kalshi-hourly-crypto.png',
    id: 'project1',
  },
  {
...
export const PHONE = '310-946-9056'
